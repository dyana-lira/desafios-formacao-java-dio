...
Uma única string indicando o serviço AWS correspondente: "EC2", "S3", "RDS", "Lambda" ou "Serviço desconhecido".
...
| Entrada | Saída |
| --- | --- |
| Preciso de um servidor para rodar aplicações | EC2 |
| Quero armazenar imagens e vídeos | S3 |
| Necessito de um banco de dados relacional | RDS |
| Preciso executar funções sem servidor | Lambda |
| Solicito um serviço de inteligência artificial | Serviço desconhecido |